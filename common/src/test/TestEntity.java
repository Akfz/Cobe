...
public class TestEntity extends Entity implements AnimatedObject {
    ...
    public TestEntity(EntityType<?> entityType, Level level) {
        ...
        //XD
        List<ActiveHitbox> activeHitboxes = ActiveHitbox.buildFromData(HitboxCache.getFromCache("/mnt/hdd/Cobe/fabric/run/AsLib/cfgPack/123/resourcePack/assets/eww/test/test.hb"), currentBoneMatrices);
